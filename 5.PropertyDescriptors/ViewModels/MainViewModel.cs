...
namespace Dynamics.ViewModels
{
    ...
    {
        public DynamicObservableCollection Songs { get; set; }
        ...
        public MainViewModel()
        {
            ...
            Songs = new DynamicObservableCollection
                    {
            ...
            Songs[0].Duck = new TimeSpan(0, 0, 4, 11);
            Songs[1].Duck = new TimeSpan(0, 0, 3, 35);
            Songs[2].Duck = new TimeSpan(0, 0, 8, 02);
        }
